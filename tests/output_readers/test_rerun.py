...
class TestRerun(object):
    def setup_method(self, test_method):
        self.patcher = patch('commandhelper.output_readers.rerun.Process')
    ...
    @patch('commandhelper.output_readers.rerun._wait_output', return_value=False)
    @patch('commandhelper.output_readers.rerun.Popen')
    ...
    @patch('commandhelper.output_readers.rerun._wait_output')
    ...
    @patch('commandhelper.output_readers.rerun._kill_process')
    ...
    @patch('commandhelper.output_readers.rerun.logs')
