...
from commandhelper.rules.wrong_hyphen_before_subcommand import match, get_new_command
...
def get_all_executables(mocker):
    mocker.patch(
        "commandhelper.rules.wrong_hyphen_before_subcommand.get_all_executables",
