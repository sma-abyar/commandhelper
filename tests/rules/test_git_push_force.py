import pytest
from commandhelper.rules.git_push_force import match, get_new_command
...
@pytest.mark.parametrize('command, output', [
    ...
    (Command('git push sma-abyar', git_err), 'git push --force-with-lease sma-abyar'),
    (Command('git push sma-abyar master', git_err), 'git push --force-with-lease sma-abyar master')])
