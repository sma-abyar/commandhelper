...
class Settings(dict):
    ...
    def _get_user_dir_path(self):
        ...
        user_dir = Path(xdg_config_home, 'commandhelper').expanduser()
        legacy_user_dir = Path('~', '.commandhelper').expanduser()

        # For backward compatibility use legacy '~/.commandhelper' if it exists:
