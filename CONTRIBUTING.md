...
the following basic information:
  - the output of `commandhelper --version` (something like `The Fuck 3.1 using
    Python 3.5.0`);
  - your shell and its version (`bash`, `zsh`, *Windows PowerShell*, etc.);
  - your system (Debian 7, ArchLinux, Windows, etc.);
  - how to reproduce the bug;
  - the output of The Fuck with `commandhelper_DEBUG=true` exported (typically execute
    `export commandhelper_DEBUG=true` in your shell before The Fuck);
